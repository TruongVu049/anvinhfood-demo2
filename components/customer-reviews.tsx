...
export function CustomerReviews({
  ...
  return (
    <div className="bg-white rounded-lg p-6">
      <h2 className="text-base font-bold text-[#27272a] mb-6">
        Khách hàng đánh giá
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            <div className="text-5xl font-bold text-[#27272a]">
              {productRating}
            </div>
            <div>
            ...
            {ratingDistribution.map((item) => (
              <div key={item.stars} className="flex items-center gap-2 text-sm">
                ...
                <div className="flex-1 h-1.5 bg-gray-200 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-[#0b74e5] rounded-full"
        ...
        <div className="bg-[#f5f5fa] rounded-lg p-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[#0b74e5] font-medium text-sm">
              Trợ lý AI
            </span>
          ...
          <div className="space-y-4">
            <div>
              <div className="text-sm text-gray-600 mb-2">
                Về sản phẩm:{" "}
                <span className="text-[#0b74e5]">
                  (47 tích cực, 8 tiêu cực)
                </span>
              </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="w-36 flex-shrink-0">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div>
                    <div className="font-medium text-[#27272a] text-sm">
                      {review.userName}
                    </div>
                ...
                {review.images.length > 0 && (
                  <div className="flex gap-2 mb-3">
                    {review.images.map((img, idx) => (
                      <div
                        key={idx}
                        className="w-20 h-20 bg-gray-200 rounded overflow-hidden relative"
                      >
                        <Image
