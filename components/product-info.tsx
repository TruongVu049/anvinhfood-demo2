...
export function ProductInfo({ product }: ProductInfoProps) {
  return (
    <div className="bg-white rounded-lg p-4 space-y-4">
      ...
      {/* Title */}
      <h1 className="text-xl font-semibold text-[#27272a] leading-tight">
        {product.name}
      </h1>
      ...
      <div className="flex items-center gap-3 text-sm">
        ...
        <span className="text-gray-500">
          Đã bán {(product.soldCount / 1000).toFixed(0)}k
        </span>
      </div>
      ...
      <div className="bg-[#fafafa] rounded-lg p-4">
        <div className="flex items-baseline gap-2">
          <span className="text-3xl font-bold text-[#ff424e]">
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-gray-700">
              Giảm <span className="font-semibold text-[#ff424e]">20.000đ</span>{" "}
              từ mã khuyến mãi
            </span>
          </div>
        </div>
      ...
      <div className="border rounded-lg p-4 space-y-3">
        ...
        <div className="bg-[#f0fff4] rounded-lg p-3">
          <div className="flex items-center gap-2">
            <span className="font-black text-[#00ab56] text-sm tracking-tight">
              NOW
            </span>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Trước 10h ngày mai:{" "}
            <span className="text-[#00ab56] font-medium">Miễn phí</span>{" "}
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600 pt-2 border-t">
          ...
          <span>
            <span className="font-semibold text-[#00ab56]">FREESHIP XTRA</span>{" "}
      ...
      <div className="border rounded-lg p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <span className="border border-[#0b74e5] text-[#0b74e5] px-3 py-1 rounded text-sm">
              Giảm 20%
            </span>
            <span className="border border-[#0b74e5] text-[#0b74e5] px-3 py-1 rounded text-sm">
              Giảm 20%
